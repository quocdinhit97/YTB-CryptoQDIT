...
namespace clearfile
{
	static class CryptoQDIT
	{
		...
		// Remove extension .qdit when Decryp
		public static string RemoveQditURL(string URL, string ex)
		{
			int so = URL.IndexOf(ex);
			return URL.Remove(so);
		}
